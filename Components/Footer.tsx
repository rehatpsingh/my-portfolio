    ...
    <div className='pt-[8rem] pb-[4rem] bg-[#02050a]'>
        ...
        md:grid-cols-2 w-[80%] mx-auto gap-[3rem]'>
            <div className='flex items-center space-x-6'>
                ...
                <div>
                    <h1 className='text-[2.5rem] mb-[0.2rem] font-semibold text-[white]'>Address</h1>
                    <p className='text-[17px] w-[90%] text-white opacity-60'>Waterloo, ON, Canada</p>
                </div>
            </div>
            <div className='flex items-center space-x-6'>
                <div className='md:w-[6.5rem] md:h-[6.5rem] w-[5rem] h-[5rem] flex items-center justify-center
                ...
                <div>
                    <h1 className='text-[2.5rem] mb-[0.2rem] font-semibold text-[white]'>Phone</h1>
                    <p className='text-[17px] w-[100%] text-white opacity-60'>+1-437-669-2101</p>
                </div>
            </div>
            <div className='flex items-center space-x-6'>
                <div className='md:w-[6.5rem] md:h-[6.5rem] w-[5rem] h-[5rem] flex items-center justify-center
                ...
                <div>
                    <h1 className='text-[2.5rem] mb-[0.2rem] font-semibold text-[white]'>Email</h1>
                    <p className='text-[17px] w-[90%] text-white opacity-60'>rehatpreet2101@gmail.com</p>
                </div>
            </div>
        </div>
        <div className='w-[80%] mt-[2rem] mx-auto grid grid-cols-1 md:grid-cols-2 items-center justify-between'>
                <div className='text-[18px] mb-[2rem] md:mb-0 text-white opacity-20'>
                    Rehatpreet Singh 2024 | All Rights Reserved
                </div>
